...
export default function Navbar() {
  return (
<>
<nav className="navbar navbar-expand-lg bg-blue py-3 sticky-top">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink className="nav-link text-white fw-bold fs-5" aria-current="page" to={'/about'}>About</NavLink>
        </li>
        <li className="nav-item">
